...
export class AllpropertylistComponent implements OnInit {
  ...
  constructor(private orderPipe: OrderPipe,public apiService:ApiService, private router: Router) { }
  ...
  allpropertydetails(property){
    console.log(property["propCode"])
    this.router.navigate(['./allpropertydetails',{id: property["propCode"], id2: property["status"]}]);
  }
